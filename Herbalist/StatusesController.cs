...
namespace KnightsCohort.Herbalist
{
    ...
    public class StatusesController
    {
        ...
        public static void Blindness_EnemyPatch(List<CardAction> __result, State s, Ship movingShip, Ship targetShip, int index, int maxMove = 99, bool movesFast = false, bool? attackWeakPoints = null, bool avoidAsteroids = false, bool avoidMines = true, bool avoidDualDrones = false)
        {
